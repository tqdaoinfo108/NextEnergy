...
import 'phone_form_field_state_custom.dart';

class PhoneFormFieldCustom extends FormField<PhoneNumber> {
  /// {@macro controller}
  final PhoneControllerCustom? controller;
  ...
  PhoneFormFieldCustom({
    ...
    this.enableIMEPersonalizedLearning = true,
        ...
        super(
          builder: (state) => (state as PhoneFormFieldCustomState).builder(),
          initialValue: controller?.value ?? initialValue,
        );

  @override
  PhoneFormFieldCustomState createState() => PhoneFormFieldCustomState();
}
