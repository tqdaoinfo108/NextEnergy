...
import 'package:v2/pages/login/widget/phone_controller_custom.dart';
import 'package:v2/pages/login/widget/phone_form_field_custom.dart';

class PhoneFormFieldCustomState extends FormFieldState<PhoneNumber> {
  late final PhoneControllerCustom controller;
  late final FocusNode focusNode;

  @override
  PhoneFormFieldCustom get widget => super.widget as PhoneFormFieldCustom;
  ...
  void _onTextfieldChanged(String value) {
    controller.changeNationalNumberCustom(value);
    didChange(controller.value);
